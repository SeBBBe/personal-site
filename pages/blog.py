...
class Blog:
    ...
    def generateposts(parent):
        ...
        for filename in files:
            ...
            imgtable = Table(1, 2, "collapsetable")
            imgtable.insertat(0, 0, Paragraph(post.description, "class=\"postdescription\""))
            imgtable.insertat(0, 1, Image(post.imagesource, "128px"))
            #postdiv.insert(Paragraph(post.description, "class=\"postdescription\""))
            imgtablediv = Div("")
            imgtablediv.insert(imgtable)
            postdiv.insert(imgtablediv)
