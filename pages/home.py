...
class Home:
    ...
    def generate(self):
        ...
        about = Paragraph(
            "I am a software professional with an M.Sc in Engineering and an eye for details. During my studies I worked part-time in sales, which has given me an excellent hand with people, something I can put to great use in my current work driving product testability. My studies concluded in 2016 with my master thesis concerning route prediction at a major automotive manufacturer, which resulted in a patented algorithm.",
            "class=\"coverbread\"")
